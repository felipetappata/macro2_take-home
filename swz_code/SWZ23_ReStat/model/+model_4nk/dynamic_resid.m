...
if T_flag
    T = model_4nk.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(8, 1);
    residual(1) = (y(11)) - (y(16)-(1-params(3))/params(6)*(y(5)-y(13)-y(12))-params(3)*(params(38)*(y(15)-y(10))+params(39)*(y(14)-y(9))));
    residual(2) = (y(6)) - (y(11)*params(36)*params(37)-T(1)*(params(38)*y(10)+params(39)*y(9))+y(13)*params(1));
