...
function [zdatalinear_ zdatapiecewise_ zdatass_ oobase_ Mbase_  Mnewviolvecbool_] = ...
...
%         violvecbool_
        ...
        Mnewviolvecbool_(iter_,:)  = newviolvecbool_';
        ...
        if (max(abs(newviolvecbool_-violvecbool_)>0)) %|| sum(relaxconstraint_(find(violvecbool_==1))>0)
            changes_ = 1;
        else
            changes_ = 0;
        end
