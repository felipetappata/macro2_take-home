...
M_.block_structure.variable_reordered = [ 5 4 6 8 1 2 7 3];
...
M_.dynamic_g1_sparse_rowval = int32([6 4 3 5 1 6 2 6 7 4 7 8 1 2 3 1 2 5 1 2 6 7 1 8 1 2 1 1 1 4 5 3 6 ]);
M_.dynamic_g1_sparse_colval = int32([1 4 5 6 9 9 10 10 11 12 12 12 13 13 13 14 14 14 15 15 15 15 16 16 18 18 21 22 23 25 26 27 28 ]);
M_.dynamic_g1_sparse_colptr = int32([1 2 2 2 3 4 5 5 5 7 9 10 13 16 19 23 25 25 27 27 27 28 29 30 30 31 32 33 34 ]);
...
M_.block_structure_stat.block(5).variable = [ 1 2 7];
...
M_.block_structure_stat.variable_reordered = [ 5 4 6 8 1 2 7 3];
...
M_.static_g1_sparse_rowval = int32([1 6 1 2 6 7 4 7 8 2 3 2 5 2 6 7 1 8 ]);
M_.static_g1_sparse_colval = int32([1 1 2 2 2 3 4 4 4 5 5 6 6 7 7 7 8 8 ]);
M_.static_g1_sparse_colptr = int32([1 3 6 7 10 12 14 17 19 ]);
load param_4nk;
...
save([M_.dname filesep 'Output' filesep 'model_4nk_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model_4nk_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model_4nk_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model_4nk_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model_4nk_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model_4nk_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model_4nk_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'model_4nk_results.mat'], 'options_mom_', '-append');
end
