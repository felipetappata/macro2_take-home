...
g1(1,15)=(-((1-params(3))/params(6)));
g1(1,9)=params(3)*(-params(39));
g1(1,17)=params(3)*params(39);
g1(1,10)=params(3)*(-params(38));
g1(1,18)=params(3)*params(38);
g1(1,11)=1;
g1(1,19)=(-1);
...
g1(4,2)=(-params(18));
g1(4,8)=1;
g1(4,20)=(-((1-params(3))*(1+params(5))/(params(6)+(1-params(3))*params(5))*params(22)));
g1(5,4)=(-params(19));
g1(5,10)=1;
g1(5,21)=(-params(23));
g1(6,1)=(-params(20));
...
g1(8,12)=1;
g1(9,5)=(-(params(3)/params(6)-1/params(6)));
g1(9,15)=(-(1/params(6)));
g1(9,7)=1;
g1(9,16)=(-1);
g1(9,13)=params(3)/params(6);
g1(10,5)=1;
g1(10,13)=(-1);
g1(10,14)=1;
