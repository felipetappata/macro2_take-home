...
(function ($) {
    ...
    $.fn.tokenize = function (options) {
        var input = this.find("input#docsearch"),
...
//      nugget_box.addClass("tokenized");
        ...
        // update the text input; run it through a text area first to decode
        // any encoded HTML entities in the response.
        var decoder = document.createElement('textarea');
        decoder.innerHTML = parsed_query.query;
        input.val(decoder.value);
